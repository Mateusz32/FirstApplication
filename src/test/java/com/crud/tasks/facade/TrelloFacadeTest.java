...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        ...
        TrelloCardDto mappedTrelloCard = new TrelloCardDto("name", "description", "pos", "listId");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "name", "url:test");
        ...
        //When
        CreatedTrelloCardDto createdTrelloCardDto1 = trelloFacade.createCard(mappedTrelloCard);

        //Then
        assertThat(createdTrelloCardDto1.getId()).isEqualTo("1");
        assertThat(createdTrelloCardDto1.getName()).isEqualTo("name");
        assertThat(createdTrelloCardDto1.getShortUrl()).isEqualTo("url:test");
    }
}